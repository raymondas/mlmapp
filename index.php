...
<div id="wrap">
    ...
    <header id="header" class="container">
        ...
        <section id="header-top" class="clearfix">
            <!-- begin header left -->
            <div class="one-half">
                <h1 id="logo"><a href="#"><img src="images/logo.png" alt="Finesse"></a></h1>
                <p id="tagline">...go for wealth</p>
            </div>
            <!-- end header left -->
            ...
            <div class="one-half column-last">
                ...
                <div class="contact-info">
                    <p class="contact-info email"><a href="mlm/register">Sign Up</a></p>
                    <p class="contact-info address"><a href="mlm">Member Login</a></p>
                </div>
                <!-- end contact info -->
            </div>
            <!-- end header right -->
        ...
        <section id="navbar" class="clearfix">
            ...
            <nav id="nav">
                <ul id="navlist" class="clearfix">
                    ...
                    <li><a href="#" data-rel="submenu3">Services</a>
    ...
    <section id="content" class="container clearfix">
        ...
        <section>
            <div class="infobox">
                <div class="infobox-inner">
                    <a class="button large" href="#">Learn More</a>
        ...
        <!-- begin services -->
        <section>
            <h2>Our Services <span class="more">&ndash; <a href="#">View All Services &raquo;</a></span></h2> 
        ...
        <section class="one-half">
            ...
            <div id="newsletter-wrap">
                <p>Subscribe to our email newsletter for useful tips and valuable resources sent out every second month.</p>
